...
.. Test case: `remind pw/WRONGPASSWORD id/VALID_LOAN_ID` +
...
.. Test case: Make sure your email is set, disable its `less secure apps` setting and refresh the setting page. Execute `remind pw/CORRECTPASSWORD id/VALID_LOAN_ID` +
Expected: Failure message "Your password might be incorrect, or you have not enabled the \"Less secure apps\" setting in your Google account settings. Please refer to the User Guide by pressing F1!" will show. The email is not sent.
.. Test case: Disconnect your network. Execute `remind pw/CORRECTPASSWORD id/VALID_LOAN_ID` +
